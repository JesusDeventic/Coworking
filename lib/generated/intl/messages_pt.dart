...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(username) => "Perfil de @${username} no VACoworking";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "authRequiredFunctionMessage": MessageLookupByLibrary.simpleMessage(
      "Esta função requer que você faça login",
    ),
    "availableRooms": MessageLookupByLibrary.simpleMessage("Salas disponíveis"),
    ...
    "dialogErrorAppVersion": MessageLookupByLibrary.simpleMessage(
      "Há uma nova versão do VACoworking disponível.\nAtualize o app para continuar",
    ),
    "dialogErrorServerConnection": MessageLookupByLibrary.simpleMessage(
      "Não foi possível conectar ao servidor VACoworking",
    ),
    ...
    "faq1Answer": MessageLookupByLibrary.simpleMessage(
      "É um aplicativo informativo sobre espaços de coworking disponíveis, categorizados por serviços e características. Ele permite pesquisar e filtrar por diferentes critérios para encontrar o espaço ideal para trabalhar.",
    ),
    "faq1Question": MessageLookupByLibrary.simpleMessage(
      "O que é o VACoworking?",
    ),
    "faq2Answer": MessageLookupByLibrary.simpleMessage(
      "Somente os administradores do aplicativo podem adicionar espaços de coworking. Para incluir mais espaços, é necessário entrar em contato com a equipe do aplicativo.",
    ),
    "faq2Question": MessageLookupByLibrary.simpleMessage(
      "Posso adicionar espaços de coworking?",
    ),
    "faq3Answer": MessageLookupByLibrary.simpleMessage(
      "Ao permitir notificações, avisos são enviados ao dispositivo com novidades ou notícias importantes sobre os espaços de coworking. Você pode configurar as notificações nas configurações do aplicativo.",
    ),
    ...
    "moreServices": MessageLookupByLibrary.simpleMessage("mais serviços"),
    ...
    "notificationsNewBadge": MessageLookupByLibrary.simpleMessage("Novo"),
    ...
    "service_access": MessageLookupByLibrary.simpleMessage("Acesso 24/7"),
    ...
    "service_cleaning": MessageLookupByLibrary.simpleMessage("Limpeza"),
    ...
    "service_reception": MessageLookupByLibrary.simpleMessage("Recepção"),
    "service_relax_zone": MessageLookupByLibrary.simpleMessage(
      "Zona de Relaxamento",
    ),
    "service_security": MessageLookupByLibrary.simpleMessage("Segurança 24h"),
    "service_social_domiciliation": MessageLookupByLibrary.simpleMessage(
      "Domínio Social",
    ),
    "service_training": MessageLookupByLibrary.simpleMessage("Treinamentos"),
